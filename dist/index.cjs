...
const Data = {
  ...
  imageUrls(id, width) {
    ...
    return images.map((img) => media.Media.wikimediaUrl(img.filename, width));
  },
  /**
  ...
  progressiveImage(id, width = 800) {
    ...
    if (!img) return null;
    return {
      placeholder: media.Media.wikimediaUrl(img.filename, 64),
      src: media.Media.wikimediaUrl(img.filename, width),
      srcHD: media.Media.wikimediaUrl(img.filename, width * 2)
    };
  },
  /**
  ...
  imageSrcset(id, widths = [640, 1280, 1920]) {
    ...
    const img = images == null ? void 0 : images[0];
    if (!img) return null;
    return media.Media.srcset(widths, (w) => media.Media.wikimediaUrl(img.filename, w));
  },
  /**
...
exports.AstroMath = AstroMath;
exports.BRIGHT_STARS = BRIGHT_STARS;
exports.CONSTANTS = CONSTANTS;
exports.CONSTELLATIONS = CONSTELLATIONS;
exports.DEEP_SKY_EXTRAS = DEEP_SKY_EXTRAS;
exports.Data = Data;
exports.ESA = ESA;
exports.Eclipse = Eclipse;
exports.IMAGE_FALLBACKS = IMAGE_FALLBACKS;
exports.MESSIER_CATALOG = MESSIER_CATALOG;
exports.METEOR_SHOWERS = METEOR_SHOWERS;
exports.Moon = Moon;
exports.NASA = NASA;
exports.PLANET_TEXTURES = PLANET_TEXTURES;
exports.SOLAR_SYSTEM = SOLAR_SYSTEM;
exports.STAR_TEXTURES = STAR_TEXTURES;
exports.SkyMap = SkyMap;
exports.Sun = Sun;
...
exports.heroCollapse = heroCollapse;
exports.heroExpand = heroExpand;
exports.mollweide = mollweide;
exports.morph = morph;
exports.renderSkyMap = renderSkyMap;
exports.resolveImages = resolveImages;
exports.resolveSimbad = resolveSimbad;
exports.staggerIn = staggerIn;
exports.staggerOut = staggerOut;
